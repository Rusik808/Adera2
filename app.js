...
const DATA = {
  ...
  productLists: {
    ...
    "radiatory/alyuminievye": [
      { id: "al-eco-500-80", title: "Радиатор алюминиевый Adera Eco 500-80", image: "img/prod_radiator_al.png", inStock: true, brand:"Adera" },
      { id: "al-premium-500-80", title: "Радиатор алюминиевый Adera Premium 500-80", image: "img/prod_radiator_al.png", inStock: true, brand:"Adera" },
    ],
...
const SHEETS = {
  ...
  GID_LISTS: '0',
  GID_PRODUCTS: '542053221',
  GID_VARIANTS: '1824993290'
};
...
async function hydrateProductsFromSheets(){
  ...
  // 1) Собираем productLists (как было)
  const map = {};
